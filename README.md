...
To build the final jar and optimize the jhipsterGmaoApplication application for production, run:
...
Then navigate to [http://localhost:80081](http://localhost:80081) in your browser.
